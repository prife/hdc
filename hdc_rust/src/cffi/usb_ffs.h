...
static UsbOsDescGuid g_osDescGuid = {
...
static UsbExtPropValues g_osPropValues = {
    .guid = g_osDescGuid,
};

static struct usb_ext_compat_desc g_wosDesc = {
...
static struct usb_os_desc_header g_wosHead = {
    .interface = LONG_LE(0),
...
static struct usb_os_desc_header g_osPropHead = {
    .interface = LONG_LE(0),
